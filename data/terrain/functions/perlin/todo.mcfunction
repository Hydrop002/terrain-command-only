# 执行者为proxy
execute unless block ~ ~ ~ minecraft:bedrock unless entity @e[tag=todo,distance=..0.1] run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0,Duration:2147483647,Tags:["todo"]}
