...
execute at @s[scores={count=1..,perlin=1..}] run setblock ~ ~ ~ minecraft:stone
...
execute if entity @s[scores={count=1..,perlin=1..}] run function terrain:perlin/generate_fill2